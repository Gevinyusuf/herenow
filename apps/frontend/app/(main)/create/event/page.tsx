      ...
      <ImagePickerModal 
        ...
        onGenerate={async () => {
          ...
          try {
            ...
            // 处理返回的图片 URL
            // 注意：OpenRouter 的图片生成可能返回优化后的提示词，实际图片生成需要集成其他服务
            // 这里假设返回的是图片 URL 或 base64 数据
            ...
            if (imageUrl.startsWith('data:image')) {
              ...
              // 如果返回的是提示词优化结果，暂时使用占位符
              // TODO: 集成实际的图片生成服务（如 Stability AI、DALL-E 等）
              console.warn('Image generation returned text instead of image URL. Actual image generation service needs to be integrated.');
              // 临时使用占位符图片
              setAiGeneratedImage(MOCK_IMAGES.tech[0].url);
            }
          } catch (error: any) {
      ...
      <main className="max-w-6xl mx-auto pt-16 sm:pt-20 md:pt-24 pb-32 sm:pb-48 md:pb-64 px-4 sm:px-6 md:px-12 lg:px-20 relative z-10">
        ...
        {isPreviewOpen && (() => {
          ...
          return (
            ...
            >
              <div className="min-h-full flex items-start justify-center p-3 sm:p-4 md:p-6 pt-20 sm:pt-24">
                <div 
                ...
                >
                  ...
                  {/* Header */}
                  <div className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-slate-200 px-3 sm:px-4 md:px-6 py-3 sm:py-4 flex items-center justify-between">
