...
from routes import home, auth, events, ai, users, communities, community_posts, community_members, community_invites, subscriptions, alipay
import logging
...
app.include_router(subscriptions.router, tags=["订阅"])
app.include_router(alipay.router, tags=["支付宝支付"])
